...
public class CachingCertificateValidator implements X509CertChainValidatorExt {
  ...
  /**
   * Checks whether the {@link CachedValidationResult} passed as argument has expired with respect
   * to the {@link #cacheEntryLifetimeMsec} defined for this validator and the reference time passed
   * as argument.
   *
...
class CachedValidationResult {
   ...
   *
   * <p>The certificate fingerprint is the SHA1 hash of the DER encoding of the certificate.
   *
   ...
   *
   * <p>It can be computed with the {@link FingerprintHelper#getFingerprint(X509Certificate)}
   * method.
   *
