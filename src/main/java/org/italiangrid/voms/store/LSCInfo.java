...
public interface LSCInfo {
   ...
   *
   * <p>The certificate chain description is a list of X.500 distinguished names encoded as strings
   * according to the OpenSSL slash-separated format, as in: <code>/C=IT/O=INFN/CN=INFN CA</code>
