...
public interface VOMSACValidator extends VOMSACParser {
	 ...
	 *  
	 * This method should be used in conjunction with the registration of a {@link ValidationResultListener} to
	 * get details about validation error and warning messages.
	 * 
	 * Use the {@link #validateWithResult(X509Certificate[])} method in case you don't want to rely on a {@link ValidationResultListener}.
	 * 
	 ...
	 * as argument (which is assumed to be validated already).
	 * 
	 * This method returns a possibly empty list of {@link VOMSValidationResult} objects which describe the outcome
	 ...
	 * relying on the registration of a {@link ValidationResultListener}. 
	 * 
	 * @param validatedChain
	 * @return a possibly empty list of {@link VOMSValidationResult} object providing access to validation results and
	 * related attributes
	 */
