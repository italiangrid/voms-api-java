...
/**
 * This strategy returns the leaf VOMS Attribute Certificate in a certificate chain, i.e. the
 * Attribute Certificate found in the latest delegation in the chain.
 *
