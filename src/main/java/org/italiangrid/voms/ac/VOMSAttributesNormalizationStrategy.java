...
/**
 * A strategy to select the set of relevant and appliable VOMS attributes from a set of parsed VOMS
 * attribute certificates.
 *
 * <p>This strategy is responsible of creating the {@link VOMSAttribute} objects which represents
