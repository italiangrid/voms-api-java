...
/**
 * This class represents the parameters required for generating an Attribute Certificate (AC). It
 * encapsulates various attributes such as Virtual Organization (VO), Fully Qualified Attribute
 * Names (FQANs), Generic Attributes (GAs), host details, validity periods, and a serial number.
 */
