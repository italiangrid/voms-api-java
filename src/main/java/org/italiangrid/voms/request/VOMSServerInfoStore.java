...
public interface VOMSServerInfoStore {
  ...
  /**
   * Returns a set of all {@link VOMSServerInfo} objects in this {@link VOMSServerInfoStore}.
   *
   * @return a possibly empty set of all {@link VOMSServerInfo} objects in this {@link
   *     VOMSServerInfoStore}.
   */
