...
public class TestFilePermissionHelper {
  ...
  public static final String keyWithAcceptedPerms = "src/test/resources/perm-test/test2.key.pem";
  ...
  public static void setupPermissions() {
    ...
    FilePermissionHelper.setFilePermissions(keyWithAcceptedPerms,
  ...
  public void testFilePermissions() throws IOException {
    ...
    FilePermissionHelper.checkPrivateKeyPermissions(keyWithAcceptedPerms);
